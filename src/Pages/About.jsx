        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I am a passionate programmer with expertise in Python and Django,
              specializing in building robust and scalable web applications.
              With a strong foundation in backend development, I excel at
              creating efficient APIs and integrating complex systems. My skill
              set extends to modern frontend technologies, enabling me to craft
              seamless user experiences. I thrive on solving challenging
